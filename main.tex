...
\begin{frame}[fragile]\frametitle{Отрицательный цикл}
    \begin{center}
        \begin{tikzpicture}
            \draw (0,  0) node(1)[circle,draw] {1};
            \draw (2,  0) node(2)[circle,draw] {2};
            \draw (3,  1) node(3)[circle,draw] {3};
            \draw (3, -1) node(4)[circle,draw] {4};
            \draw (4,  0) node(5)[circle,draw] {5};
            \draw (6,  0) node(6)[circle,draw] {6};
            \draw[thick] (1) -- (2) node[pos=0.5,above,sloped,color=blue] {100};
            \draw[thick] (2) -- (3) node[pos=0.5,above,sloped,color=blue] {-1};
            \draw[thick] (5) -- (3) node[pos=0.5,above,sloped,color=blue] {-1};
            \draw[thick] (2) -- (4) node[pos=0.5,below,sloped,color=blue] {-1};
            \draw[thick] (5) -- (4) node[pos=0.5,below,sloped,color=blue] {-1};
            \draw[thick] (5) -- (6) node[pos=0.5,above,sloped,color=blue] {100};
        \end{tikzpicture}
    \end{center}
\end{frame}

\begin{frame}[fragile]\frametitle{Ford-Bellman algorithm}
    $O(mn)$
...
\begin{frame}[fragile]\frametitle{Floyd algorithm}
    $O(n^3)$
